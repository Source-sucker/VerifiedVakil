...
export const CONDENSED_IPL_LAW_BANK: LawEntry[] = [
  // 1. SECURITY DEPOSIT & FORFEITURE PENALTIES
  {
    ...
    intelligentSuggestion: "Cite Kailash Nath Associates v. DDA to your landlord: 'Under Section 74, deposit deductions are legally restricted to actual documented losses, not punitive forfeitures.'",
  ...
  },
  {
    ...
    intelligentSuggestion: "Propose: 'In accordance with the Constitution Bench in Fateh Chand, let us limit any early exit penalty to actual re-listing costs rather than blanket deposit forfeiture.'",
  ...
  // 2. EVICTION & PROTECTION OF SETTLED POSSESSION
  {
    ...
    intelligentSuggestion: "Remind landlord: 'Under Bishandas, physical possession cannot be disturbed without due process of law. Any dispute must be settled through agreed formal notice.'",
  ...
  },
  {
    ...
    intelligentSuggestion: "Discussion point: 'Our right to quiet enjoyment and peaceful possession is protected by the Supreme Court in Ramesh Chand Ardawatiya; all entries and exits must follow written notice.'",
  ...
  },
  {
    ...
    intelligentSuggestion: "Clarify exit terms: 'Per Lallu Yeshwant Singh, eviction must follow due legal notice; let us establish a fair 30-day handover grace period in the clause.'",
  ...
  // 3. PRIVACY & LANDLORD ENTRY RIGHTS
  {
    ...
    intelligentSuggestion: "Request amendment: 'Please update Clause X to require 24 hours' prior notice between 7 AM and 8 PM for inspections, as mandated by Section 15 of the Model Tenancy Act.'",
    primarySourceUrl: "https://mohua.gov.in/upload/uploadfiles/files/Model_Tenancy_Act_English.pdf",
  },
  {
    ...
    intelligentSuggestion: "Insist: 'Section 108(c) of TPA guarantees uninterrupted quiet enjoyment; inspections should be scheduled with mutual convenience rather than open-ended entry.'",
  ...
  // 4. LEASE DURATION, 11-MONTH CUSTOM & REGISTRATION
  {
    ...
    intelligentSuggestion: "Clarify status: 'As held in Associated Hotels v. R.N. Kapoor, operational exclusive possession governs our rights; let us ensure termination and notice rights are balanced.'",
  ...
  },
  {
    ...
    intelligentSuggestion: "Suggest: 'Per C.M. Beena, contract labels cannot bypass standard fairness. Can we ensure notice periods apply symmetrically to both parties?'",
  ...
  },
  {
    ...
    courtOrAuthority: "Supreme Court of India",
    citation: "(2000) 6 SCC 394",
    year: 2000,
    statuteReference: "Registration Act, 1908 § 17/49 & TPA, 1882 § 106",
    condensedRule: "Unregistered agreements exceeding 11 months cannot create a long-term lease, but acceptance of rent creates a valid month-to-month tenancy terminable by 15 days' notice under Section 106 TPA. Explains why 11-month residential agreements are standard in India.",
    ...
    intelligentSuggestion: "Clarify term: 'Under Anthony v. K.C. Ittoop, 11-month tenancies operate under Section 106 monthly notice standards. Let us stipulate an explicit 30-day notice period for both sides.'",
