      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-3.5 border-b border-slate-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-2 py-1 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-white border border-slate-800 transition-colors flex items-center gap-1 text-[11px] font-mono"
            title={expanded ? "Collapse clause details" : "Expand clause details"}
            aria-expanded={expanded}
          >
            <span className="hidden sm:inline text-[10px]">{expanded ? "Collapse" : "Expand"}</span>
